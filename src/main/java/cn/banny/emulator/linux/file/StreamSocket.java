...
public class StreamSocket extends SocketIO implements FileIO {

    private static final Log log = LogFactory.getLog(StreamSocket.class);

    private final Socket socket = new Socket();

    private final Emulator emulator;

    public StreamSocket(Emulator emulator) {
